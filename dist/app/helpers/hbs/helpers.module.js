...
var HelpersModule = /** @class */ (function () {
    function HelpersModule() {
        this.Modules = [];
        this.Modules = this.Modules.concat(login_1.LoginHelperManager, admin_keys_1.AdminnHelperManager, menu_1.MenuHelperManager, general_1.GeneralHelperManager, matilde_1.MatildeHelperManager);
